...
public class LoadingView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        String loadText = typedArray.getString(R.styleable.LoadingView_loadingText2);
        int textAppearance = typedArray.getResourceId(R.styleable.LoadingView_loadingText2, -1);
